...
export function creerCommandes(options: OptionsCommandes): Command[] {
  ...
  const commandes: Command[] = [
    ...
    previewCommand,
    creerRenameCommand(originalNickStore, cooldownRename, settingsStore),
    creerRenamePendingCommand(originalNickStore, Date.now, settingsStore),
    creerRenameCancelCommand(originalNickStore, settingsStore),
    creerRandomCommand(cooldownRename, settingsStore),
